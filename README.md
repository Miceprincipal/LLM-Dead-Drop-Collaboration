...
<h3 data-section-id="3p1dlm" data-start="172" data-end="209">Tested with Codex and Claude Code</h3>
<p data-start="211" data-end="344">A drop-in protocol for coordinating two LLM coding agents through a shared <code data-start="286" data-end="300">agentchat.md</code> file and zero-data dead-drop notifications.</p>
